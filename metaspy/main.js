...
const cookieFilePath = path.join(__dirname, 'checkin_src', 'data', 'cookies.json');
...
(async () => {
    if (!fs.existsSync(cookieFilePath)) {
        ...
        await require(path.join(__dirname, 'checkin_src', 'api', 'login.js'))(email, password, tfa);
    }
    ...
    const data = await require(path.join(__dirname, 'checkin_src', 'api', 'crawler.js'))(cookies, {
        ...userInput,
